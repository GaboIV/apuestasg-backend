								...
								<tr>
									<td >
										<div class='tk_generado' *ngFor="let tk of _inicioSesion.ticketes">
						                    ...
						                    <div class="ttlhr">
						                        <div class="ttl_hr">Carr. 10</div>
						                        <div class="ttl2_hr">
						                            <div style="font-size: 0.8em;">01/01/2020
						                                01:01 a.m. </div>
						                            <div class='ttl_hipo'>La Rinconada</div>
						                        </div>
						                    </div>
						                    <div class='separador1_tk'></div>
						                    <div class="hr_r1">
						                        <div style="text-align: left">Bs. 30.000.000,00 a ganar</div>
						                        <div style="float: right; text-align: right;">Bs. 30.000.000,00</div>
						                    </div>
						                    <div class="hr_r2">
						                        10 - Caballo Viejo
						                    </div>
						                    ...
						                    <table class="footer" cellspacing="0" cellpadding="0">
						                    	<tr>
						                    		...
						                    		<td style="text-align: right;">Bs. 30.000.000,00</td>
						                    	</tr>
						                    	<tr>
						                    		<td style="text-align: left;">A00000001</td>
						                    		<td style="text-align: center;">01-01-2020</td>
						                    		<td style="text-align: right;">01:01 a.m.</td>
						                    	</tr>
						                    </table>
						                </div>
									</td>
								...
								<tr>
									<td>
										...
										<tr style="font-size: 12px">
											<td style="color: grey">N.º de asistencia: <?php echo $assist_id ?></td>
